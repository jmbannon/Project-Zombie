...
// * @author jbannon
// */
//public class CrackshotLoreBACKUP 
//{
...
//        final Condition initialCondition = gun.getCondition(initialDurability);
...
//        int durability = Integer.valueOf(infoSplit[INFO_DUR_IDX]);
//        
//        if (gun == null || durability <= 0) // Gun is already broken
//            return null;
//        
//        final Condition oldCondition = Condition.getCondition(durability, gun.getDurabilitySet().getMaxDurability());
//        final Condition newCondition = Condition.getCondition(--durability, gun.getDurabilitySet().getMaxDurability());
//        
//        final int build = Integer.valueOf(infoSplit[INFO_BUILD_IDX]);
...
//        {
//            durability = CrackshotLoreBACKUP.getDurability(originalGunItem);
//            condition = newGun.getCondition(durability);
//            newLore = CrackshotLoreBACKUP.generateLore(newGun, durability, condition);
...
//        {
//            newLore = CrackshotLoreBACKUP.setWeaponID(newGun.getUniqueID(), newLore);
//            newMeta.setLore(newLore);
//            return newGunItem;
//        }
//        else
...
//        stb.append(seperator);
//        stb.append(gun.getCondition(durability));
//        stb.append(seperator);
//        stb.append(0);
...
//    {       
//        return CrackshotLoreBACKUP.isPostShotWeapon(item) && CrackshotLoreBACKUP.getDurability(item) <= 0;
//    }
//    
//    static
