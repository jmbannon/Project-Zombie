...
import custom_weapons.csv.CSVValue;
import custom_weapons.utilities.CrackshotLore;
import custom_weapons.utilities.GunUtils;
...
import custom_weapons.modifiers.projectile.BaseDamageAttributes;
import custom_weapons.modifiers.projectile.BleedoutAttributes;
...
import custom_weapons.modifiers.projectile.HeadshotAttributes;
import custom_weapons.modifiers.projectile.IgniteAttributes;
import custom_weapons.modifiers.projectile.StunAttributes;
import custom_weapons.modifiers.projectile.FireDamageAttributes;
import custom_weapons.modifiers.projectile.ShrapnelDamageAttributes;
import custom_weapons.modifiers.skeleton.BoltAttributes;
import custom_weapons.modifiers.skeleton.DurabilityAttributes;
...
public abstract class GunModifier extends CSVValue
{
    ...
    public ArrayList<String> getLore()
    {
        ...
        if (this instanceof BleedoutAttributes)     stats.addAll(getBleedoutStats((BleedoutAttributes)this));
        if (this instanceof BoltAttributes)         stats.addAll(getBoltModifierStats((BoltAttributes)this));
        if (this instanceof BulletSpreadAttributes) stats.addAll(getBulletSpreadModifierStats((BulletSpreadAttributes)this));
        if (this instanceof CritAttributes)         stats.addAll(getCritModifierStats((CritAttributes)this));
        if (this instanceof BaseDamageAttributes)       stats.addAll(getDamageModifierStats((BaseDamageAttributes)this));
        if (this instanceof HeadshotAttributes)     stats.addAll(getHeadshotModifierStats((HeadshotAttributes)this));
        if (this instanceof DurabilityAttributes)   stats.addAll(getDurabilityModifierStats((DurabilityAttributes)this));
        if (this instanceof FireModeAttributes)     stats.addAll(getFireModeModifierStats((FireModeAttributes)this));
        if (this instanceof IgniteAttributes)       stats.addAll(getIgniteModifierStats((IgniteAttributes)this));
    ...
    static
    private ArrayList<String> getBleedoutStats(final BleedoutAttributes bleedoutMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getBoltModifierStats(final BoltAttributes boltMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    ArrayList<String> getBulletSpreadModifierStats(final BulletSpreadAttributes bsMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getCritModifierStats(final CritAttributes critMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getDamageModifierStats(final BaseDamageAttributes damageMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getHeadshotModifierStats(final HeadshotAttributes headMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getDurabilityModifierStats(final DurabilityAttributes durMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getFireModeModifierStats(final FireModeAttributes durMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getIncendiaryModifierStats(final FireDamageAttributes incMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getIgniteModifierStats(final IgniteAttributes ignMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getMagazineModifierStats(final MagazineAttributes magMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getProjectileModifierStats(final ProjectileAttributes projMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
        final String projBoost = getValueStat(projMod.getProjectileAmount(), "projectiles");
    ...
    static
    private ArrayList<String> getShrapnelModifierStats(final ShrapnelDamageAttributes shrapMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getStunModifierStats(final StunAttributes stunMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
    ...
    static
    private ArrayList<String> getSilencerModifierStats(final SilencerAttributes silMod)
    {
        final ArrayList<String> stats = new ArrayList<>();
