...
{
          //Name, Type, Id, Byte, Delay, Durability, Damage, Recoil, ShootSound, ShootSilenced, ParticleShoot , Rel, RelDur, ReloadSound
    ...
    USP    ("USP"         , PISTOL,   292, 0,  5,  120, 8,  0, "BLAZE_HIT-1-1-0",         "BLAZE_HIT-1-1-0", null,       12, 30, "WITHER_IDLE-1-1-2"),
    ...
    G3SG1 ("G3SG1",         AUTO_S,   277, 0,  11, 120, 12, 0, "ANVIL_BREAK-7-1-1",        "BAT_IDLE-2-1-1", null,       20, 55, "SHEEP_IDLE-1-1-2"),
    DRAG  ("Dragonuv",      AUTO_S,   351, 14, 17, 120, 16, 0, "SKELETON_IDLE-6-1-0",      null,           "FLAMES-1",   10, 40, "WITHER_SHOOT-1-1-0"),
    
    REMINGTON   ("Remington 700",       HUNTING, 351, 12, 0, 120, 15, 0, "PIG_WALK-6-1-0",       null, "FLAMES-1", 6, 13, "SHEEP_SHEAR-1-1-0"),
    SPRINGFIELD ("M1903 Springfield",   HUNTING, 351, 13, 0, 120, 15, 0, "SKELETON_DEATH-6-1-0", null, "FLAMES-1", 6, 13, "SHEEP_SHEAR-1-1-0"),
    MODEL70     ("Winchester Model 70", HUNTING, 351, 9,  0, 120, 15, 0, "SHEEP_WALK-5-1-0",     null, "FLAMES-1", 5, 13, "SHEEP_SHEAR-1-1-0"),
