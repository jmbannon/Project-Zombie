...
{
    static private final Bolt2[] bolts = buildBolts();
    ...
    @Override public GunModifier2[] getAll() { return bolts; }
    @Override public GunModifier2 getNullModifier() { return new Bolt2(); }
